...
var languageCodeSet = new Set(Object.values(LanguageGeocoding));
...
function addCommonForwardAndReverseGeocodingOptions(searchParams, options) {
  const { apiKey, limit, types: types2, excludeTypes } = options;
  searchParams.set("key", apiKey ?? config.apiKey);
  if (limit != void 0) {
    searchParams.set("limit", String(limit));
  }
  if (types2 != void 0) {
    searchParams.set("types", types2.join(","));
  }
...
function transform(_0) {
  return __async(this, arguments, function* (positions, options = {}) {
    const coordinatesStr = (Array.isArray(positions[0]) ? positions : [positions]).map((coord2) => `${coord2[0]},${coord2[1]}`).join(";");
    const endpoint = new URL(
...
function expandMapStyle(style2) {
  const maptilerDomainRegex = /^maptiler:\/\/(.*)/;
  let match;
  const trimmed = style2.trim();
  let expandedStyle;
...
var MapStyleVariant = class {
  constructor(name2, variantType, id, referenceStyle, description2, imageURL) {
    this.name = name2;
...
function styleToStyle(style2) {
  if (!style2) {
    return MapStyle[mapStylePresetList[0].referenceStyleID].getDefaultVariant().getId();
  }
  if (typeof style2 === "string" || style2 instanceof String) {
    return style2.trim().toLowerCase();
  }
  if (style2 instanceof MapStyleVariant) {
    return style2.getId();
  }
  if (style2 instanceof ReferenceMapStyle) {
    return style2.getDefaultVariant().getId();
  }
}
...
function centered(center, zoom, options = {}) {
  const style2 = styleToStyle(options.style);
  ...
  const endpoint = new URL(
    `maps/${encodeURIComponent(style2)}/static/${center[0]},${center[1]},${zoom}/${width}x${height}${scale}.${format}`,
    defaults.maptilerApiURL
  );
...
function bounded(boundingBox, options = {}) {
  ...
  const endpoint = new URL(
    `maps/${encodeURIComponent(style2)}/static/${boundingBox[0]},${boundingBox[1]},${boundingBox[2]},${boundingBox[3]}/${width}x${height}${scale}.${format}`,
    defaults.maptilerApiURL
  );
  if ("attribution" in options) {
    endpoint.searchParams.set("attribution", options.attribution.toString());
...
function batch(_0) {
  return __async(this, arguments, function* (positions, options = {}) {
    ...
    const tileArrayBuffers = yield Promise.all(
    ...
    const tilePixelDatas = yield Promise.all(
...
function fromLineString(_0) {
  return __async(this, arguments, function* (ls, options = {}) {
...
var languagesIsoSet = new Set(Object.values(Language));
function isLanguageSupported(lang) {
  return languagesIsoSet.has(lang);
}
var languageCodeSet2 = new Set(Object.values(Language));
function getBrowserLanguage() {
  ...
  ).filter((l) => languageCodeSet2.has(l));
...
var MAPTILER_SESSION_ID = v4_default();
var SdkConfig = class extends import_events.default {
  constructor() {
    super();
    __publicField$7(this, "primaryLanguage", defaults2.primaryLanguage);
...
var config$1 = new SdkConfig();
var LogoControl = class extends import_maplibre_gl.default.LogoControl {
  onAdd(map) {
...
var MaptilerLogoControl = class extends LogoControl {
  constructor(options = {}) {
    var _a, _b;
    super(options);
    __publicField$6(this, "logoURL", "");
    __publicField$6(this, "linkURL", "");
    this.logoURL = (_a = options.logoURL) != null ? _a : defaults2.maptilerLogoURL;
    this.linkURL = (_b = options.linkURL) != null ? _b : defaults2.maptilerURL;
  }
  onAdd(map) {
    var _a;
    this._map = map;
...
var LOCAL_CACHE_PROTOCOL_SOURCE = "localcache_source";
var LOCAL_CACHE_PROTOCOL_DATA = "localcache";
var LOCAL_CACHE_NAME = "maptiler_sdk";
var CACHE_LIMIT_ITEMS = 1e3;
var CACHE_LIMIT_CHECK_INTERVAL = 100;
function localCacheTransformRequest(reqUrl, resourceType) {
  if (config$1.caching && config$1.session && reqUrl.host === defaults2.maptilerApiHost) {
...
function enableRTL() {
  if (import_maplibre_gl.default.getRTLTextPluginStatus() === "unavailable") {
    import_maplibre_gl.default.setRTLTextPlugin(
      defaults2.rtlPluginURL,
      (err) => {
        if (err)
          console.error(err);
      },
...
function maptilerCloudTransformRequest(url, resourceType) {
  ...
  if (reqUrl.host === defaults2.maptilerApiHost) {
...
function styleToStyle2(style2) {
  if (!style2) {
    return MapStyle[mapStylePresetList[0].referenceStyleID].getDefaultVariant().getExpandedStyleURL();
  }
  if (typeof style2 === "string" || style2 instanceof String) {
    if (!style2.startsWith("http") && style2.toLowerCase().includes(".json")) {
      return style2;
    } else {
      return expandMapStyle(style2);
    }
  }
  if (style2 instanceof MapStyleVariant) {
    return style2.getExpandedStyleURL();
  }
  if (style2 instanceof ReferenceMapStyle) {
    return style2.getDefaultVariant().getExpandedStyleURL();
  }
  return style2;
}
...
var MaptilerTerrainControl = class {
  constructor() {
...
var NavigationControl = class extends import_maplibre_gl.default.NavigationControl {
  onAdd(map) {
    return super.onAdd(map);
  }
};
...
var MaptilerNavigationControl = class extends NavigationControl {
  constructor() {
    super({
      showCompass: true,
      showZoom: true,
...
var GeolocateControl = class extends import_maplibre_gl.default.GeolocateControl {
  onAdd(map) {
    return super.onAdd(map);
  }
};
...
var Marker$1 = import_maplibre_gl.default.Marker;
var LngLat$1 = import_maplibre_gl.default.LngLat;
var LngLatBounds$1 = import_maplibre_gl.default.LngLatBounds;
var MaptilerGeolocateControl = class extends GeolocateControl {
  constructor() {
    super(...arguments);
...
var AttributionControl = class extends import_maplibre_gl.default.AttributionControl {
  onAdd(map) {
    return super.onAdd(map);
  }
};
var ScaleControl = class extends import_maplibre_gl.default.ScaleControl {
  onAdd(map) {
    return super.onAdd(map);
  }
};
var FullscreenControl = class extends import_maplibre_gl.default.FullscreenControl {
  onAdd(map) {
    return super.onAdd(map);
  }
};
...
var _desync;
var _addParentRect;
var addParentRect_fn;
var _setParentBounds;
var setParentBounds_fn;
var _syncMaps;
var syncMaps_fn;
var Minimap = class {
  ...
  setStyle(style2, options) {
    if (!__privateGet(this, _differentStyle))
      this.map.setStyle(style2, options);
  ...
  setPaintProperty(layerId, name2, value, options) {
    if (!__privateGet(this, _differentStyle))
      this.map.setPaintProperty(layerId, name2, value, options);
    __privateMethod(this, _setParentBounds, setParentBounds_fn).call(this);
    return this;
  }
  setLayoutProperty(layerId, name2, value, options) {
    if (!__privateGet(this, _differentStyle))
      this.map.setLayoutProperty(layerId, name2, value, options);
    __privateMethod(this, _setParentBounds, setParentBounds_fn).call(this);
    return this;
  }
  ...
  onAdd(parentMap) {
    ...
    this.map = new Map2(__privateGet(this, _options));
...
_parentMap = /* @__PURE__ */ new WeakMap();
_container = /* @__PURE__ */ new WeakMap();
_canvasContainer = /* @__PURE__ */ new WeakMap();
_parentRect = /* @__PURE__ */ new WeakMap();
_differentStyle = /* @__PURE__ */ new WeakMap();
_desync = /* @__PURE__ */ new WeakMap();
_addParentRect = /* @__PURE__ */ new WeakSet();
...
_setParentBounds = /* @__PURE__ */ new WeakSet();
...
_syncMaps = /* @__PURE__ */ new WeakSet();
...
var Map2 = class extends import_maplibre_gl.default.Map {
  constructor(options) {
    var _a, _b, _c;
    if (options.apiKey) {
      config$1.apiKey = options.apiKey;
    }
    const style2 = styleToStyle2(options.style);
      ...
      if (locationResult.state === "granted") {
        navigator.geolocation.getCurrentPosition(
          ...
          (data2) => {
            ...
            if (this.terrain) {
              this.easeTo({
                center: [data2.coords.longitude, data2.coords.latitude],
  ...
  setStyle(style2, options) {
    var _a;
    (_a = this.minimap) == null ? void 0 : _a.setStyle(style2);
    this.forceLanguageUpdate = true;
    this.once("idle", () => {
      this.forceLanguageUpdate = false;
    });
    return super.setStyle(styleToStyle2(style2), options);
  }
  /**
  ...
  setPaintProperty(layerId, name2, value, options) {
    var _a;
    (_a = this.minimap) == null ? void 0 : _a.setPaintProperty(layerId, name2, value, options);
    return super.setPaintProperty(layerId, name2, value, options);
  }
  /**
  ...
  setLayoutProperty(layerId, name2, value, options) {
    var _a;
    (_a = this.minimap) == null ? void 0 : _a.setLayoutProperty(layerId, name2, value, options);
    return super.setLayoutProperty(layerId, name2, value, options);
  }
  /**
  ...
  setPrimaryLanguage(language) {
    ...
    for (const genericLayer of layers) {
      ...
      if (sourceURL.host !== defaults2.maptilerApiHost) {
        continue;
      }
  ...
  enableTerrain(exaggeration = this.terrainExaggeration) {
    ...
    const addTerrain = () => {
      ...
      this.addSource(defaults2.terrainSourceId, {
        type: "raster-dem",
        url: defaults2.terrainSourceURL
      });
      this.setTerrain({
        source: defaults2.terrainSourceId,
        exaggeration: 0
      });
    };
    if (this.getTerrain()) {
    ...
    if (this.loaded() || this.isTerrainEnabled) {
      ...
      this.once("load", () => {
        if (this.getTerrain() && this.getSource(defaults2.terrainSourceId)) {
          return;
        }
        addTerrain();
      });
  ...
  disableTerrain() {
    ...
    const updateExaggeration = () => {
      ...
      if (positionInLoop < 0.99) {
        ...
        this.terrainFlattening = false;
        this.setTerrain();
        if (this.getSource(defaults2.terrainSourceId)) {
          this.removeSource(defaults2.terrainSourceId);
        }
      }
      this.triggerRepaint();
    };
...
var Marker = class extends import_maplibre_gl.default.Marker {
  addTo(map) {
    return super.addTo(map);
  }
};
var Popup = class extends import_maplibre_gl.default.Popup {
  addTo(map) {
    return super.addTo(map);
  }
};
var Style = class extends import_maplibre_gl.default.Style {
  constructor(map, options = {}) {
    super(map, options);
  }
};
var CanvasSource = class extends import_maplibre_gl.default.CanvasSource {
  onAdd(map) {
    super.onAdd(map);
  }
};
var GeoJSONSource = class extends import_maplibre_gl.default.GeoJSONSource {
  onAdd(map) {
    super.onAdd(map);
  }
};
var ImageSource = class extends import_maplibre_gl.default.ImageSource {
  onAdd(map) {
    super.onAdd(map);
  }
};
var RasterTileSource = class extends import_maplibre_gl.default.RasterTileSource {
  onAdd(map) {
    super.onAdd(map);
  }
};
var RasterDEMTileSource = class extends import_maplibre_gl.default.RasterDEMTileSource {
  onAdd(map) {
    super.onAdd(map);
  }
};
var VectorTileSource = class extends import_maplibre_gl.default.VectorTileSource {
  onAdd(map) {
    super.onAdd(map);
  }
};
var VideoSource = class extends import_maplibre_gl.default.VideoSource {
  onAdd(map) {
    super.onAdd(map);
  }
};
var TerrainControl = class extends import_maplibre_gl.default.TerrainControl {
  onAdd(map) {
    return super.onAdd(map);
  }
};
var BoxZoomHandler = class extends import_maplibre_gl.default.BoxZoomHandler {
  constructor(map, options) {
    super(map, options);
  }
};
var ScrollZoomHandler = class extends import_maplibre_gl.default.ScrollZoomHandler {
  constructor(map, triggerRenderFrame) {
    super(map, triggerRenderFrame);
  }
};
var CooperativeGesturesHandler = class extends import_maplibre_gl.default.CooperativeGesturesHandler {
  constructor(map, options) {
    super(map, options);
  }
};
var KeyboardHandler = class extends import_maplibre_gl.default.KeyboardHandler {
  constructor(map) {
    super(map);
  }
};
var TwoFingersTouchPitchHandler = class extends import_maplibre_gl.default.TwoFingersTouchPitchHandler {
  constructor(map) {
    super(map);
  }
};
var MapWheelEvent = class extends import_maplibre_gl.default.MapWheelEvent {
  constructor(type2, map, originalEvent) {
    super(type2, map, originalEvent);
  }
};
var MapTouchEvent = class extends import_maplibre_gl.default.MapTouchEvent {
  constructor(type2, map, originalEvent) {
    super(type2, map, originalEvent);
  }
};
var MapMouseEvent = class extends import_maplibre_gl.default.MapMouseEvent {
  constructor(type2, map, originalEvent, data2 = {}) {
    super(type2, map, originalEvent, data2);
  }
};
...
function gpx(doc) {
  ...
  const tracks = get2(doc, "trk");
  const routes = get2(doc, "rte");
  const waypoints = get2(doc, "wpt");
  const gj = {
...
function kml(doc, xml2string) {
  ...
  const styleByHash = {};
  const styleMapIndex = {};
  const placemarks = get2(doc, "Placemark");
  const styles = get2(doc, "Style");
  const styleMaps = get2(doc, "StyleMap");
  for (const style2 of Array.from(styles)) {
    const hash = okhash(
      xml2string !== void 0 ? xml2string(style2) : xml2str(style2)
    ).toString(16);
    styleIndex["#" + attr(style2, "id")] = hash;
    styleByHash[hash] = style2;
  }
  for (const styleMap of Array.from(styleMaps)) {
    ...
    const pairs = get2(styleMap, "Pair");
    const pairsMap = {};
...
function gxCoords(root) {
  var _a;
  let elems = get2(root, "coord");
  const coords = [];
  const times = [];
  if (elems.length === 0)
    elems = get2(root, "gx:coord");
  for (const elem of Array.from(elems)) {
    coords.push(gxCoord((_a = nodeVal(elem)) != null ? _a : ""));
  }
  const timeElems = get2(root, "when");
...
function getGeometry(root) {
  ...
  for (i = 0; i < geotypes.length; i++) {
    geomNodes = get2(root, geotypes[i]);
    if (geomNodes) {
      for (j = 0; j < geomNodes.length; j++) {
        ...
        if (geotypes[i] === "Point") {
          ...
          const rings = get2(geomNode, "LinearRing");
          const coords = [];
...
function getPlacemark(root, styleIndex, styleByHash, styleMapIndex) {
  ...
  const properties = {};
  const name2 = nodeVal(get1(root, "name"));
  const address = nodeVal(get1(root, "address"));
  const description2 = nodeVal(get1(root, "description"));
  ...
  if (styleUrl) {
    ...
    const style2 = styleByHash[(_b = properties.styleHash) != null ? _b : ""];
    if (style2) {
      if (!lineStyle)
        lineStyle = get1(style2, "LineStyle");
      if (!polyStyle)
        polyStyle = get1(style2, "PolyStyle");
      const iconStyle = get1(style2, "IconStyle");
      if (iconStyle) {
  ...
  if (extendedData) {
    const datas = get2(extendedData, "Data"), simpleDatas = get2(extendedData, "SimpleData");
...
function getTrack(node) {
  const segments = get2(node, "trkseg");
  const track = [];
  const times = [];
  const heartRates = [];
  let line;
  ...
  if (extensions) {
    ...
    if (lineStyle) {
      ...
      if (color)
        style2.stroke = color;
      if (!isNaN(opacity))
        style2["stroke-opacity"] = opacity;
      if (!isNaN(width))
        style2["stroke-width"] = width * 96 / 25.4;
    }
  }
  return style2;
}
...
var ColorRamp = class _ColorRamp extends Array {
  constructor(options = {}) {
    super();
  ...
  scale(min, max, options = { clone: true }) {
    ...
    return clone ? new _ColorRamp({ stops }) : this;
  }
  ...
  clone() {
    return new _ColorRamp({ stops: this.getRawColorStops() });
  }
  getRawColorStops() {
    const stops = [];
    for (let i = 0; i < this.length; i += 1) {
  ...
  resample(method, samples = 15) {
    ...
    const outputNormalized = new _ColorRamp({ stops });
...
function colorDrivenByProperty(style2, property) {
  return [
    "interpolate",
    ["linear"],
    ["get", property],
    ...style2.map((el) => [el.value, el.color]).flat()
  ];
}
function radiusDrivenByProperty(style2, property, zoomCompensation = true) {
  if (!zoomCompensation) {
    return [
      "interpolate",
      ["linear"],
      ["get", property],
      ...style2.map((el) => [el.value, el.pointRadius]).flat()
    ];
  }
  return [
    "interpolate",
    ...
    [
      ...
      ["linear"],
      ["get", property],
      ...style2.map((el) => [el.value, el.pointRadius * 0.025]).flat()
    ],
    2,
    [
      "interpolate",
      ["linear"],
      ["get", property],
      ...style2.map((el) => [el.value, el.pointRadius * 0.05]).flat()
    ],
    4,
    [
      "interpolate",
      ["linear"],
      ["get", property],
      ...style2.map((el) => [el.value, el.pointRadius * 0.1]).flat()
    ],
    8,
    [
      "interpolate",
      ["linear"],
      ["get", property],
      ...style2.map((el) => [el.value, el.pointRadius * 0.25]).flat()
    ],
    16,
    [
      "interpolate",
...
function radiusDrivenByPropertyHeatmap(style2, property, zoomCompensation = true) {
  if (!zoomCompensation) {
    return [
      "interpolate",
      ["linear"],
      ["get", property],
      ...style2.map((el) => [el.propertyValue, el.value]).flat()
    ];
  }
  return [
    "interpolate",
    ...
    [
      ...
      ["linear"],
      ["get", property],
      ...style2.map((el) => [el.propertyValue, el.value * 0.025]).flat()
    ],
    2,
    [
      "interpolate",
      ["linear"],
      ["get", property],
      ...style2.map((el) => [el.propertyValue, el.value * 0.05]).flat()
    ],
    4,
    [
      "interpolate",
      ["linear"],
      ["get", property],
      ...style2.map((el) => [el.propertyValue, el.value * 0.1]).flat()
    ],
    8,
    [
      "interpolate",
      ["linear"],
      ["get", property],
      ...style2.map((el) => [el.propertyValue, el.value * 0.25]).flat()
    ],
    16,
    [
      "interpolate",
...
function addPolyline(_0, _1) {
  return __async2(this, arguments, function* (map, options, fetchOptions = {}) {
    var _a, _b, _c;
    ...
    if (typeof data2 === "string") {
      if (isUUID(data2)) {
        data2 = `https://api.maptiler.com/data/${options.data}/features.json?key=${config$1.apiKey}`;
      } else if (((_a = data2.split(".").pop()) == null ? void 0 : _a.toLowerCase().trim()) === "gpx") {
        const res = yield fetch(data2, fetchOptions);
        const gpxStr = yield res.text();
        data2 = gpx(gpxStr);
      } else if (((_b = data2.split(".").pop()) == null ? void 0 : _b.toLowerCase().trim()) === "kml") {
        const res = yield fetch(data2, fetchOptions);
...
function addPolygon(map, options) {
  ...
  if (options.data && !map.getSource(sourceId)) {
    let data2 = options.data;
    if (typeof data2 === "string" && isUUID(data2)) {
      data2 = `https://api.maptiler.com/data/${data2}/features.json?key=${config$1.apiKey}`;
    }
    map.addSource(sourceId, {
      type: "geojson",
      data: data2
...
function getMapLibreVersion() {
  return import_maplibre_gl.default.getVersion();
}
var MapMLGL = import_maplibre_gl.default.Map;
var MarkerMLGL = import_maplibre_gl.default.Marker;
var PopupMLGL = import_maplibre_gl.default.Popup;
var StyleMLGL = import_maplibre_gl.default.Style;
var CanvasSourceMLGL = import_maplibre_gl.default.CanvasSource;
var GeoJSONSourceMLGL = import_maplibre_gl.default.GeoJSONSource;
var ImageSourceMLGL = import_maplibre_gl.default.ImageSource;
var RasterTileSourceMLGL = import_maplibre_gl.default.RasterTileSource;
var RasterDEMTileSourceMLGL = import_maplibre_gl.default.RasterDEMTileSource;
var VectorTileSourceMLGL = import_maplibre_gl.default.VectorTileSource;
var VideoSourceMLGL = import_maplibre_gl.default.VideoSource;
import_maplibre_gl.default.NavigationControl;
import_maplibre_gl.default.GeolocateControl;
import_maplibre_gl.default.AttributionControl;
import_maplibre_gl.default.LogoControl;
import_maplibre_gl.default.ScaleControl;
import_maplibre_gl.default.FullscreenControl;
import_maplibre_gl.default.TerrainControl;
var BoxZoomHandlerMLGL = import_maplibre_gl.default.BoxZoomHandler;
var ScrollZoomHandlerMLGL = import_maplibre_gl.default.ScrollZoomHandler;
var CooperativeGesturesHandlerMLGL = import_maplibre_gl.default.CooperativeGesturesHandler;
var KeyboardHandlerMLGL = import_maplibre_gl.default.KeyboardHandler;
var TwoFingersTouchPitchHandlerMLGL = import_maplibre_gl.default.TwoFingersTouchPitchHandler;
var MapWheelEventMLGL = import_maplibre_gl.default.MapWheelEvent;
var MapTouchEventMLGL = import_maplibre_gl.default.MapTouchEvent;
var MapMouseEventMLGL = import_maplibre_gl.default.MapMouseEvent;
export {
  AJAXError,
  AttributionControl,
  BoxZoomHandler,
