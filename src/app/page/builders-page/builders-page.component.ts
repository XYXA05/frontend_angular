...
export class BuildersPageComponent implements OnInit {
  ...
  public getMethodOwner(){
    this.http.get(`https://www.mark-build.com/user/${this.id}/`).subscribe((data:any) =>{
      console.log(data);
  ...
  public getNews() {
    this.http.get<any[]>(`https://www.mark-build.com/get_news_id/${this.id}/`).subscribe((data:any) => {
      this.getNewsData = data;
    });
  }

  public getMethod() {
    this.http.get<any[]>(`https://www.mark-build.com/get_items/${this.id}/`).subscribe((data:any) => {
      this.jsonDataa = data;
    });
  }
  ...
  public getVideoUrl(id: string): SafeResourceUrl {
    return this.sanitizer.bypassSecurityTrustResourceUrl(`https://www.mark-build.com/get_image/1/${id}/`);
  }
  public getVideoOwnerUrl(id: string): SafeResourceUrl {
    return this.sanitizer.bypassSecurityTrustResourceUrl(`https://www.mark-build.com/get_image_owner/1/${id}`);
  }
