...
export class NewBuildComponent implements OnInit{
  ...
  public getMethods(id: number): void {
    this.http.get(`https://www.mark-build.com/items/${id}/`).subscribe((data: any) => {
      console.log(data);
      this.jsonData = data;
...
filterItems(
  ...
  this.http.get<DescriptionItem[]>('https://www.mark-build.com/filter_items/', { params }).subscribe(
      (data) => {
