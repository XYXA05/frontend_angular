...
export class NewBuildAboutTheProjectComponent implements OnInit, AfterViewInit{
  ...
  public getMethodOwnerAboutDescription(): void {
    this.http.get(`https://www.mark-build.com/get_items_for_document_description/${this.id}/`).subscribe((data: any) => {
      console.log(data);
      this.getTermsOfFinancing = data;
    });
  }
  public getMethodOwner(ownerId: number){
    this.http.get(`https://www.mark-build.com/user/${ownerId}/`).subscribe((data:any) =>{
      console.log(data);
  ...
  public getMethodOwnerAbout(){
    this.http.get(`https://www.mark-build.com/get_items_for_about/${this.id}`).subscribe((data:any) =>{
  ...
  public getImagesFromPosition(position: number){
    this.http.get(`https://www.mark-build.com/get_images/${position}/${this.id}/`).subscribe((data:any) =>{
      console.log(data);
  ...
  public getVideoUrl(position: number): SafeResourceUrl {
    return this.sanitizer.bypassSecurityTrustResourceUrl(`https://www.mark-build.com/get_image/${position}/${this.id}/`);
  }
  ...
  public getVideoFromPosition(id: number): SafeResourceUrl {
    if (id) {
      return this.sanitizer.bypassSecurityTrustResourceUrl(`https://www.mark-build.com/get_image_about/${id}`);
    } else {
