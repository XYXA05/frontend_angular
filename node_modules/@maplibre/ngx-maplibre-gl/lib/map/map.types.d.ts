...
import { GeolocateControl, Map, MapLibreEvent, MapLibreZoomEvent, MapContextEvent, MapDataEvent, MapLayerMouseEvent, MapLayerTouchEvent, MapMouseEvent, MapSourceDataEvent, MapStyleDataEvent, MapTouchEvent, MapWheelEvent } from 'maplibre-gl';
...
export type MapImageData = HTMLImageElement | ArrayBufferView | {
    width: number;
    height: number;
